...
#---GUI construction---#FFFFFF#FF8040-------------------------------------------
    ...
    def _init_coll_main_notebook_Pages(self, parent):
        parent.AddPage( page=self.uni_notebook, select=True,
              text=u'Univariate')
        parent.AddPage( page=self.multi_notebook, select=False,
              text=u'Multivariate')
        parent.AddPage( page=self.avgr_notebook, select=False,
              text=u'Consensus')
        parent.AddPage( page=self.overall_notebook, select=False,
              text=u'Overall')
    ...
    def _init_coll_uni_notebook_Pages(self, parent):
        _and = '&&'
        parent.AddPage( page=self.line_panel, select=True,
              text=u'Line Plots')
        parent.AddPage( page=self.mean_std_panel, select=False,
              text=u'Mean '+ _and +' STD Plots')
        parent.AddPage( page=self.corr_panel, select=False,
              text=u'Correlation Plots')
        parent.AddPage( page=self.profile_panel, select=False,
              text=u'Profile Plots')
        parent.AddPage( page=self.egg_panel, select=False,
              text=u'Eggshell Plots')
        parent.AddPage( page=self.f_panel, select=False,
              text=u'F ' + _and + ' p Plots')
        parent.AddPage( page=self.mse_panel, select=False,
              text=u'MSE Plots')
        parent.AddPage( page=self.pmse_panel, select=False,
              text=u'p-MSE Plots')
    ...
    def _init_coll_multi_notebook_Pages(self, parent):
        parent.AddPage( page=self.tuck1_panel, select=True,
              text=u'Tucker-1 Plots')
        parent.AddPage( page=self.manh_panel, select=False,
    ...
    def _init_coll_avgr_notebook_Pages(self, parent):
        parent.AddPage( page=self.org_panel, select=True,
              text=u'Original')
        parent.AddPage( page=self.std_panel, select=False,
              text=u'Standardized')
        parent.AddPage( page=self.statis_panel, select=False,
              text=u'STATIS')
    ...
    def _init_coll_overall_notebook_Pages(self, parent):
        parent.AddPage( page=self.mm_anova_panel1, select=True,
              text=u'2-way ANOVA (1 rep)')
        parent.AddPage( page=self.mm_anova_panel2, select=False,
              text=u'2-way ANOVA')
        parent.AddPage( page=self.mm_anova_panel3, select=False,
              text=u'3-way ANOVA')                     
        #parent.AddPage( page=self.perf_ind_panel, select=False, item=u'Performance Indices')
    ...
    def _init_ctrls(self, prnt):
        wx.Frame.__init__(self, id=wx.NewId(), name=u'Main_Frame',
              parent=prnt, pos=wx.Point(331, 170),
              style=wx.DEFAULT_FRAME_STYLE,
              title='PanelCheck V1.4.2')
        self._init_utils()
        ...
        self.statusBar = wx.StatusBar(id=wx.NewId(),
              name=u'statusBar', parent=self, style=wx.STB_DEFAULT_STYLE)
   #     self.statusBar.SetToolTip(u'statusBar')
        ...
        self.profile_panel.lower_right_sizer.Add(self.profile_radioBoxModel, 0, wx.CLOSE_BOX)
        ...
        self.sizer.Add(self.main_notebook, 1, wx.EXPAND)
