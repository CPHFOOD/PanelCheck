...
InitOperators(PyObject *dictionary) {
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        equal_functions, equal_data, equal_signatures, 21,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        greater_functions, greater_data, greater_signatures, 21,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        greater_equal_functions, greater_equal_data, greater_equal_signatures, 21,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        less_functions, less_data, less_signatures, 21,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        less_equal_functions, less_equal_data, less_equal_signatures, 21,
    ...
    Py_DECREF(f);
    f = PyUFunc_FromFuncAndData(
        not_equal_functions, not_equal_data, not_equal_signatures, 21,
